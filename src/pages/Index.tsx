                ...
                <div>
                  {!isMobile && (phase === "idle" || phase === "recording") && (
                    <div>
                      ...
                      {/* Quote Box */}
                      <div style={{
                        marginTop: 32, marginBottom: 32, padding: "48px 32px", border: "1px solid #e2e2e2",
                        textAlign: "center", display: "flex", flexDirection: "column", alignItems: "center", gap: 16,
                      }}>
                        <div style={{
                          fontFamily: "'Syne', sans-serif", fontSize: "clamp(1rem, 2vw, 1.3rem)", color: "#0a0a0a",
                          fontWeight: 400, letterSpacing: "0.12em", lineHeight: 1.8, textTransform: "uppercase",
                        }}>
                          Great speakers aren't born. They're trained.
                        </div>
                      ...
                      <button
                        onClick={() => navigate("/custom-practice")}
                        style={{
                          marginTop: 0, padding: "24px 28px", background: "#fff", border: "1px solid #e2e2e2",
                          cursor: "pointer", fontFamily: "'DM Mono', monospace", textAlign: "left",
