    ...
    <div style={{ minHeight: "100vh", background: c.bg, fontFamily: "'DM Mono', monospace" }}>
      ...
      <div style={{ paddingLeft: sidebarWidth, transition: "padding-left 0.25s cubic-bezier(0.4, 0, 0.2, 1)" }}>
        <div style={{ padding: "40px 48px 24px" }}>
          <div style={{ fontSize: 22, fontWeight: 700, color: c.text, fontFamily: "'Syne', sans-serif" }}>Badges</div>
          <div style={{ fontSize: 11, color: c.muted, marginTop: 6, fontFamily: "'DM Mono', monospace" }}>Earn badges by building streaks and hitting milestones</div>
        </div>
